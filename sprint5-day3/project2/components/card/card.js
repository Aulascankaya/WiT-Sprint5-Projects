...
function card(obj) {
  ...
  contentText.textContent = obj.paragraph;
  //content div a
  const contentNav = document.createElement('a');
  contentNav.href = obj.navigationURL;
  contentNav.textContent = 'Devamı...';
  /*
  contentDiv.appendChild(contentText);
  contentDiv.appendChild(contentNav);
...
*/
  contentDiv.append(contentText, contentNav);
  cardDiv.append(cardImg, title, space, contentDiv);
...
cardDataList.forEach((data) => container.appendChild(card(data)));
