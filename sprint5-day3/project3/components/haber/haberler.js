...
function HaberYapici(obj) {
  ...
  contentFirst.textContent = obj.ilkParagraf;

  const contentSecond = document.createElement('p');
  contentSecond.textContent = obj.ikinciParagraf;

  const contentThird = document.createElement('p');
  contentThird.textContent = obj.ucuncuParagraf;
...
data.forEach((i) => articles.appendChild(HaberYapici(i)));
